...
export class lineDrawer
{
    ...
    public bilboardRaycast(mX: number, mY: number, points: THREE.Vector3[], camera: OrbitCamera, quickRaycastSnap: boolean) {
        ...
        if (intersects.length > 0) {
            ...
            else if(this.inter2 == null)
            {
                ...
                if(this.inter1.distanceTo(this.inter2)>1e-6 && this.drawingType === drawTypes.lines){        
                    ...
                    this.lineBuffer.push({ A: this.inter1, B: this.inter2, color: this.scene.lineMaterial.color.clone()} as line)
            ...
            else
            {
                ...
                this.angleBuffer.push({ A: this.inter1, B: this.inter2, C: this.inter3,  color: this.scene.angleMaterial.color.clone()} as angle) 
    ...
    bilbordgen(points: THREE.Vector3[], camera: OrbitCamera, skips: number): THREE.Object3D
    {
    ...
    heightsProjection(A: THREE.Vector3, B: THREE.Vector3, C: THREE.Vector3, snapTable: THREE.Vector3[]){
    ...
    findClosestPoint(targetPoint: THREE.Vector3, snapList: THREE.Vector3[], bil: THREE.Object3D): THREE.Vector3
    {
    ...
    generateAngle(A: THREE.Vector3, B: THREE.Vector3, C: THREE.Vector3): THREE.Vector3[]{
