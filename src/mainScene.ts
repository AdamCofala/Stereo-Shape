...
export default class mainScene extends THREE.Scene
{
    ...
    public drawLines()
    {
        ...
        {
            const points: THREE.Vector3[]= [this.linedrawer.lineBuffer[i].A, this.linedrawer.lineBuffer[i].B]
    ...
    public drawAngles()
    {
        ...
        {
            const points: THREE.Vector3[]= this.linedrawer.generateAngle(this.linedrawer.angleBuffer[i].A,this.linedrawer.angleBuffer[i].B, this.linedrawer.angleBuffer[i].C)
    ...
    private createLine2(points: THREE.Vector3[], material: LineMaterial, closed: boolean = false): Line2 {
